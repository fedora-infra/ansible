...
{% for channel in [ 'default', 'osbuild', 'appliance', 'vm', 'secure-boot', 'compose', 'eclipse', 'images', 'image'] + group.extra_channels|default([]) %}
...
{% for user_id, principal in [('3445', 'compose/koji.stg.fedoraproject.org'),
                               ('3199', 'koschei/koschei-backend01.stg.rdu3.fedoraproject.org'),
                               ('3139', 'hotness/hotness01.stg.rdu3.fedoraproject.org'),
                               ('3538', 'osbs/osbs.stg.fedoraproject.org'),
                               ('428', 'bodhi/bodhi.stg.fedoraproject.org'),
                               ('3638', 'autosign/autosign01.stg.rdu3.fedoraproject.org'),
