...
host openqa-x86-worker01 {
     hardware ethernet c4:70:bd:b7:7c:16;
...
host openqa-x86-worker02 {
     hardware ethernet c4:70:bd:aa:5b:d2;
...
host openqa-x86-worker04 {
     hardware ethernet c4:70:bd:c8:c7:0e;
...
host buildhw-a64-03.mgmt.rdu3.fedoraproject.org {
     hardware ethernet D8:5E:D3:8B:89:6E;
     fixed-address 10.16.160.80;
     option host-name "buildhw-a64-03.mgmt.rdu3.fedoraproject.org";
}

host buildhw-a64-04.mgmt.rdu3.fedoraproject.org {
     hardware ethernet D8:5E:D3:8B:5D:DA;
     fixed-address 10.16.160.81;
     option host-name "buildhw-a64-04.mgmt.rdu3.fedoraproject.org";
}

host buildhw-a64-05.mgmt.rdu3.fedoraproject.org {
     hardware ethernet D8:5E:D3:8B:5F:72;
     fixed-address 10.16.160.82;
     option host-name "buildhw-a64-05.mgmt.rdu3.fedoraproject.org";
}

host buildhw-a64-06.mgmt.rdu3.fedoraproject.org {
     hardware ethernet D8:5E:D3:8B:5F:3A;
     fixed-address 10.16.160.83;
     option host-name "buildhw-a64-06.mgmt.rdu3.fedoraproject.org";
}

host buildhw-a64-07.mgmt.rdu3.fedoraproject.org {
     hardware ethernet D8:5E:D3:8B:73:D8;
     fixed-address 10.16.160.84;
     option host-name "buildhw-a64-07.mgmt.rdu3.fedoraproject.org";
}

host bvmhost-a64-05.mgmt.rdu3.fedoraproject.org {
     hardware ethernet D8:5E:D3:8B:5C:C6;
     fixed-address 10.16.160.84;
     option host-name "bvmhost-a64-05.mgmt.rdu3.fedoraproject.org";
}

host openqa-a64-worker03.mgmt.rdu3.fedoraproject.org {
     hardware ethernet D8:5E:D3:81:2B:26;
     fixed-address 10.16.160.143;
     option host-name "openqa-a64-worker03.mgmt.rdu3.fedoraproject.org";
}

host openqa-a64-worker04.mgmt.rdu3.fedoraproject.org {
     hardware ethernet D8:5E:D3:8B:5D:2A;
     fixed-address 10.16.160.84;
     option host-name "openqa-a64-worker04.mgmt.rdu3.fedoraproject.org";
}

host openqa-a64-worker05.mgmt.rdu3.fedoraproject.org {
     hardware ethernet D8:5E:D3:8B:5B:BE;
     fixed-address 10.16.160.116;
     option host-name "openqa-a64-worker05.mgmt.rdu3.fedoraproject.org";
}

host openqa-a64-worker06.mgmt.rdu3.fedoraproject.org {
     hardware ethernet D8:5E:D3:8B:5D:4A;
     fixed-address 10.16.160.118;
     option host-name "openqa-a64-worker06.mgmt.rdu3.fedoraproject.org";
}
...
host bvmhost-p09-01-stg.mgmt.rdu3.fedoraproject.org {
     hardware ethernet 08:94:ef:81:30:86;
     fixed-address 10.16.160.62;
     option host-name "bvmhost-p09-01-stg.mgmt.rdu3.fedoraproject.org";
}

host buildhw-x86-05.mgmt.rdu3.fedoraproject.org {
     hardware ethernet c8:4b:d6:8a:59:6a;
     fixed-address 10.16.160.16;
     option host-name "buildhw-x86-05.mgmt.rdu3.fedoraproject.org";
}

host buildhw-x86-06.mgmt.rdu3.fedoraproject.org {
     hardware ethernet c8:4b:d6:8a:69:a2;
     fixed-address 10.16.160.17;
     option host-name "buildhw-x86-06.mgmt.rdu3.fedoraproject.org";
}
...
host buildhw-x86-07.mgmt.rdu3.fedoraproject.org {
     hardware ethernet c8:4b:d6:8a:4a:a0;
     fixed-address 10.16.160.18;
     option host-name "buildhw-x86-07.mgmt.rdu3.fedoraproject.org";
}

host buildhw-x86-08.mgmt.rdu3.fedoraproject.org {
     hardware ethernet 70:b5:e8:ed:2a:a4;
     fixed-address 10.16.160.19;
     option host-name "buildhw-x86-08.mgmt.rdu3.fedoraproject.org";
}

host buildhw-x86-09.mgmt.rdu3.fedoraproject.org {
     hardware ethernet 70:b5:e8:ed:27:e0;
     fixed-address 10.16.160.21;
     option host-name "buildhw-x86-09.mgmt.rdu3.fedoraproject.org";
}

host buildhw-x86-10.mgmt.rdu3.fedoraproject.org {
     hardware ethernet 70:b5:e8:ed:31:16;
     fixed-address 10.16.160.22;
     option host-name "buildhw-x86-10.mgmt.rdu3.fedoraproject.org";
}
...
host buildhw-x86-12.mgmt.rdu3.fedoraproject.org {
     hardware ethernet 70:b5:e8:ed:31:0a;
     fixed-address 10.16.160.86;
     option host-name "buildhw-x86-12.mgmt.rdu3.fedoraproject.org";
}

host buildhw-x86-13.mgmt.rdu3.fedoraproject.org {
     hardware ethernet 70:b5:e8:ed:26:78;
     fixed-address 10.16.160.87;
     option host-name "buildhw-x86-13.mgmt.rdu3.fedoraproject.org";
}

host buildhw-x86-14.mgmt.rdu3.fedoraproject.org {
     hardware ethernet b4:45:06:fb:84:28;
     fixed-address 10.16.160.88;
     option host-name "buildhw-x86-14.mgmt.rdu3.fedoraproject.org";
}

host buildhw-x86-15.mgmt.rdu3.fedoraproject.org {
     hardware ethernet b4:45:06:fb:83:48;
     fixed-address 10.16.160.89;
     option host-name "buildhw-x86-15.mgmt.rdu3.fedoraproject.org";
}

host buildhw-x86-16.mgmt.rdu3.fedoraproject.org {
     hardware ethernet b4:45:06:fb:8b:38;
     fixed-address 10.16.160.90;
     option host-name "buildhw-x86-16.mgmt.rdu3.fedoraproject.org";
}

host buildhw-x86-17.mgmt.rdu3.fedoraproject.org {
     hardware ethernet b4:45:06:fb:86:90;
     fixed-address 10.16.160.79;
     option host-name "buildhw-x86-17.mgmt.rdu3.fedoraproject.org";
}

host openqa-x86-worker06.mgmt.rdu3.fedoraproject.org {
     hardware ethernet c8:4b:d6:a6:d0:d9;
     fixed-address 10.16.160.41;
     option host-name "openqa-x86-worker06.mgmt.rdu3.fedoraproject.org";
}

host openqa-x86-worker07.mgmt.rdu3.fedoraproject.org {
     hardware ethernet c8:4b:d6:a6:de:89;
     fixed-address 10.16.160.121;
     option host-name "openqa-x86-worker07.mgmt.rdu3.fedoraproject.org";
}

host openqa-x86-worker08.mgmt.rdu3.fedoraproject.org {
     hardware ethernet a8:3c:a5:42:20:72;
     fixed-address 10.16.160.122;
     option host-name "openqa-x86-worker08.mgmt.rdu3.fedoraproject.org";
}

host openqa-x86-worker09.mgmt.rdu3.fedoraproject.org {
     hardware ethernet a8:3c:a5:37:a8:ec;
     fixed-address 10.16.160.123;
     option host-name "openqa-x86-worker09.mgmt.rdu3.fedoraproject.org";
}

host openqa-x86-worker10.mgmt.rdu3.fedoraproject.org {
     hardware ethernet a8:3c:a5:37:a6:9a;
     fixed-address 10.16.160.124;
     option host-name "openqa-x86-worker10.mgmt.rdu3.fedoraproject.org";
}
