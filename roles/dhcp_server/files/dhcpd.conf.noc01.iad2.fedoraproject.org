...
host buildhw-a64-07 {
     hardware ethernet 50:6b:4b:6a:ef:70 ;
     fixed-address 10.3.170.15;
     filename "uefi/grubaa64.efi";
     next-server 10.3.163.10;
     option routers 10.3.170.254;
     option subnet-mask 255.255.255.0;
...
host buildhw-a64-01 {
     ...
     fixed-address 10.3.170.121;
     option routers 10.3.170.254;
     option host-name "buildhw-a64-01";
}

host buildhw-a64-02 {
     hardware ethernet 50:6b:4b:6a:ec:90;
     fixed-address 10.3.170.122;
     option routers 10.3.170.254;
